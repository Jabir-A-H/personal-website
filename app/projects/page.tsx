  ...
  return (
    <div className="w-full flex flex-col text-neutral-700 dark:text-neutral-300 py-8 min-h-screen relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <header className="mb-20 flex flex-col items-start border-b border-neutral-200 dark:border-neutral-800 pb-12 relative">
          ...
          <AnimatedHeading 
            className="text-6xl md:text-8xl lg:text-[9rem] font-sans font-black tracking-tighter text-neutral-900 dark:text-white mb-6 uppercase leading-none"
          >
            Projects
          </AnimatedHeading>
        ...
        <section className="mb-32">
          ...
          <div className="flex flex-col gap-16">
            {liveProjects.map((project) => (
              <AnimatedProjectCard 
                key={project.title}
                className="group flex flex-col lg:flex-row border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-950/50 backdrop-blur-sm relative"
              >
                {/* Corner Accents */}
                ...
                <div className="w-full p-8 md:p-12 flex flex-col justify-between relative z-10">
                  <div>
                    ...
                    <h3 className="text-3xl md:text-4xl font-sans font-bold text-neutral-900 dark:text-white mb-6 tracking-tight">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 max-w-md">
                      ...
                      {project.repo && (
                        project.visibility === 'PUBLIC' ? (
                          ...
                          <span className="flex-1 flex items-center justify-center gap-2 font-mono text-[10px] border border-neutral-300 dark:border-neutral-700/50 text-muted px-6 py-4 uppercase tracking-widest cursor-default">
